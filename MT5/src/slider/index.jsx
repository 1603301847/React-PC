                ...
                <div className="mt-input-number">
                    <div className="mt-input-number-handler-wrap">
                        <span className="mt-input-number-handler">
                            <i className="iconfont icon-jiantou-up mt-input-number-icon" onClick={() => this.handleAdd()}></i>
                        </span>
                        <span className="mt-input-number-handler">
                            <i className="iconfont icon-jiantou-down mt-input-number-icon" onClick={() => this.handleReduce()}></i>
                        </span>
                    </div>
